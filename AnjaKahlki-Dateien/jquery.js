...
(function(e, t) {
    ...
    v.Callbacks = function(e) {
        ...
        p.setAttribute("className", "t"), p.innerHTML = "  <link/><table></table><a href='../Unknown.html'>a</a><input type='checkbox'/>", n = p.getElementsByTagName("*"), r = p.getElementsByTagName("a")[0];
    ...
    v.event = {
        ...
        function(e, t) {
            ...
            var n, r, i, s, o, u, a, f, l, c, h = !0,
                ...
                G = K(function(e) {
                    return e.innerHTML = "<a href='jquery.js.html#'></a>", e.firstChild && typeof e.firstChild.getAttribute !== p && e.firstChild.getAttribute("href") === "#"
                }),
                Y = K(function(e) {
                ...
                for (var I = 0; I < o[1]; I++) {
                    ...
                    for (var Y = 0; Y < Q; Y++) {
                        ...
                        for (var W = 0; W < 7; W++) {
                            ...
                            Z += '<td class="' + ((W + T + 6) % 7 >= 5 ? " ui-datepicker-week-end" : "") + (tt ? " ui-datepicker-other-month" : "") + (G.getTime() == q.getTime() && p == e.selectedMonth && e._keyEvent || H.getTime() == G.getTime() && H.getTime() == q.getTime() ? " " + this._dayOverClass : "") + (nt ? " " + this._unselectableClass + " ui-state-disabled" : "") + (tt && !_ ? "" : " " + et[1] + (G.getTime() == l.getTime() ? " " + this._currentClass : "") + (G.getTime() == t.getTime() ? " ui-datepicker-today" : "")) + '"' + ((!tt || _) && et[2] ? ' title="' + et[2] + '"' : "") + (nt ? "" : ' data-handler="selectDay" data-event="click" data-month="' + G.getMonth() + '" data-year="' + G.getFullYear() + '"') + ">" + (tt && !_ ? "&#xa0;" : nt ? '<span class="ui-state-default">' + G.getDate() + "</span>" : '<a class="ui-state-default' + (G.getTime() == t.getTime() ? " ui-state-highlight" : "") + (G.getTime() == l.getTime() ? " ui-state-active" : "") + (tt ? " ui-priority-secondary" : "") + '" href="jquery.js.html#">' + G.getDate() + "</a>") + "</td>", G.setDate(G.getDate() + 1), G = this._daylightSavingAdjust(G)
                        }
                        U += Z + "</tr>"
                    }
    ...
    e.widget("ui.dialog", {
        ...
        _create: function() {
            ...
            s = (this.uiDialog = e("<div>")).addClass(n + r.dialogClass).css({
                ...
                s.focus()
            }).prependTo(s), u = e("<a href='jquery.js.html#'></a>").addClass("ui-dialog-titlebar-close  ui-corner-all").attr("role", "button").click(function(e) {
...
(function(e, t) {
    ...
    e.widget("ui.tabs", {
        ...
        options: {
            add: null,
            remove: null,
            tabTemplate: "<li><a href='jquery.js.html#%7Bhref%7D'><span>#{label}</span></a></li>"
        },
        add: function(n, r, i) {
